This file contains the application that was first used at the Be Curious 2022 event. Please make sure that you download the FeatureExtract.py file and have the following files installed:
- sounddevice
- soundfile
- numpy
- pandas
